...
* [ ] **3.1 Atoms (30 SP)**
  * [ ] 3.1.1 Refactor `Button` component to `src/ui/atoms/Button/Button.tsx`. (5 SP)
    * [ ] 3.1.1.1 Create `Button.test.tsx` for unit tests. (5 SP)
    * [ ] 3.1.1.2 Create `Button.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.1.1.3 Create `README.md` for `Button`. (2 SP)
    * [ ] 3.1.1.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.1.2 Refactor `Avatar` component to `src/ui/atoms/Avatar/Avatar.tsx`. (5 SP)
    * [ ] 3.1.2.1 Create `Avatar.test.tsx` for unit tests. (5 SP)
    * [ ] 3.1.2.2 Create `Avatar.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.1.2.3 Create `README.md` for `Avatar`. (2 SP)
    * [ ] 3.1.2.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.1.3 Refactor `Icon` component to `src/ui/atoms/Icon/Icon.tsx`. (5 SP)
    * [ ] 3.1.3.1 Create `Icon.test.tsx` for unit tests. (5 SP)
    * [ ] 3.1.3.2 Create `Icon.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.1.3.3 Create `README.md` for `Icon`. (2 SP)
    * [ ] 3.1.3.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.1.4 Refactor `Input` component to `src/ui/atoms/Input/Input.tsx`. (5 SP)
    * [ ] 3.1.4.1 Create `Input.test.tsx` for unit tests. (5 SP)
    * [ ] 3.1.4.2 Create `Input.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.1.4.3 Create `README.md` for `Input`. (2 SP)
    * [ ] 3.1.4.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.1.5 Refactor `Typography` component to `src/ui/atoms/Typography/Typography.tsx`. (5 SP)
    * [ ] 3.1.5.1 Create `Typography.test.tsx` for unit tests. (5 SP)
    * [ ] 3.1.5.2 Create `Typography.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.1.5.3 Create `README.md` for `Typography`. (2 SP)
    * [ ] 3.1.5.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.1.6 Refactor `LoadingSpinner` component to `src/ui/atoms/LoadingSpinner/LoadingSpinner.tsx`. (3 SP)
    * [ ] 3.1.6.1 Create `LoadingSpinner.test.tsx` for unit tests. (3 SP)
    * [ ] 3.1.6.2 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.1.7 Refactor `BackgroundPattern` component to `src/ui/atoms/BackgroundPattern/BackgroundPattern.tsx`. (3 SP)
    * [ ] 3.1.7.1 Create `BackgroundPattern.test.tsx` for unit tests. (3 SP)
    * [ ] 3.1.7.2 Create `BackgroundPattern.stories.tsx` for Storybook. (3 SP)
    * [ ] 3.1.7.3 Create `README.md` for `BackgroundPattern`. (1 SP)
    * [ ] 3.1.7.4 Create `index.ts` for barrel export. (1 SP)
* [ ] **3.2 Molecules (30 SP)**
  * [ ] 3.2.1 Refactor `Card` component to `src/ui/molecules/Card/Card.tsx`. (5 SP)
    * [ ] 3.2.1.1 Create `Card.test.tsx` for unit tests. (5 SP)
    * [ ] 3.2.1.2 Create `Card.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.2.1.3 Create `README.md` for `Card`. (2 SP)
    * [ ] 3.2.1.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.2.2 Refactor `ListItem` component to `src/ui/molecules/ListItem/ListItem.tsx`. (5 SP)
    * [ ] 3.2.2.1 Create `ListItem.test.tsx` for unit tests. (5 SP)
    * [ ] 3.2.2.2 Create `ListItem.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.2.2.3 Create `README.md` for `ListItem`. (2 SP)
    * [ ] 3.2.2.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.2.3 Refactor `NotificationItem` component to `src/ui/molecules/NotificationItem/NotificationItem.tsx`. (5 SP)
    * [ ] 3.2.3.1 Create `NotificationItem.test.tsx` for unit tests. (5 SP)
    * [ ] 3.2.3.2 Create `NotificationItem.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.2.3.3 Create `README.md` for `NotificationItem`. (2 SP)
    * [ ] 3.2.3.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.2.4 Refactor `ProgressBar` component to `src/ui/molecules/ProgressBar/ProgressBar.tsx`. (5 SP)
    * [ ] 3.2.4.1 Create `ProgressBar.test.tsx` for unit tests. (5 SP)
    * [ ] 3.2.4.2 Create `ProgressBar.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.2.4.3 Create `README.md` for `ProgressBar`. (2 SP)
    * [ ] 3.2.4.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.2.5 Refactor `QuickAction` component to `src/ui/molecules/QuickAction/QuickAction.tsx`. (5 SP)
    * [ ] 3.2.5.1 Create `QuickAction.test.tsx` for unit tests. (5 SP)
    * [ ] 3.2.5.2 Create `QuickAction.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.2.5.3 Create `README.md` for `QuickAction`. (2 SP)
    * [ ] 3.2.5.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.2.6 Refactor `StudentSelectionList` component to `src/ui/molecules/StudentSelectionList/StudentSelectionList.tsx`. (5 SP)
    * [ ] 3.2.6.1 Create `StudentSelectionList.test.tsx` for unit tests. (5 SP)
    * [ ] 3.2.6.2 Create `StudentSelectionList.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.2.6.3 Create `README.md` for `StudentSelectionList`. (2 SP)
    * [ ] 3.2.6.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.2.7 Refactor `BulkActionBar` component to `src/ui/molecules/BulkActionBar/BulkActionBar.tsx`. (5 SP)
    * [ ] 3.2.7.1 Create `BulkActionBar.test.tsx` for unit tests. (5 SP)
    * [ ] 3.2.7.2 Create `BulkActionBar.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.2.7.3 Create `README.md` for `BulkActionBar`. (2 SP)
    * [ ] 3.2.7.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.2.8 Refactor `BreadcrumbNavigation` component to `src/ui/molecules/BreadcrumbNavigation/BreadcrumbNavigation.tsx`. (3 SP)
    * [ ] 3.2.8.1 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.2.9 Refactor `EmptyState` component to `src/ui/molecules/EmptyState/EmptyState.tsx`. (3 SP)
    * [ ] 3.2.9.1 Create `EmptyState.test.tsx` for unit tests. (3 SP)
  * [ ] 3.2.10 Refactor `ErrorMessage` component to `src/ui/molecules/ErrorMessage/ErrorMessage.tsx`. (3 SP)
  * [ ] 3.2.11 Refactor `SkeletonCard` component to `src/ui/molecules/SkeletonCard/SkeletonCard.tsx`. (3 SP)
    * [ ] 3.2.11.1 Create `SkeletonCard.test.tsx` for unit tests. (3 SP)
  * [ ] 3.2.12 Refactor `LogoutButton` component to `src/ui/molecules/LogoutButton.tsx`. (2 SP)
* [ ] **3.3 Organisms (20 SP)**
  * [ ] 3.3.1 Refactor `Header` component to `src/ui/organisms/Header/Header.tsx`. (5 SP)
    * [ ] 3.3.1.1 Create `Header.test.tsx` for unit tests. (5 SP)
    * [ ] 3.3.1.2 Create `Header.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.3.1.3 Create `README.md` for `Header`. (2 SP)
    * [ ] 3.3.1.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.3.2 Refactor `Modal` component to `src/ui/organisms/Modal/Modal.tsx`. (5 SP)
    * [ ] 3.3.2.1 Create `Modal.test.tsx` for unit tests. (5 SP)
    * [ ] 3.3.2.2 Create `Modal.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.3.2.3 Create `README.md` for `Modal`. (2 SP)
    * [ ] 3.3.2.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.3.3 Refactor `NavigationPanel` component to `src/ui/organisms/NavigationPanel/NavigationPanel.tsx`. (5 SP)
    * [ ] 3.3.3.1 Create `NavigationPanel.test.tsx` for unit tests. (5 SP)
    * [ ] 3.3.3.2 Create `NavigationPanel.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.3.3.3 Create `README.md` for `NavigationPanel`. (2 SP)
    * [ ] 3.3.3.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.3.4 Refactor `TabBar` component to `src/ui/organisms/TabBar/TabBar.tsx`. (5 SP)
    * [ ] 3.3.4.1 Create `TabBar.test.tsx` for unit tests. (5 SP)
    * [ ] 3.3.4.2 Create `TabBar.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.3.4.3 Create `README.md` for `TabBar`. (2 SP)
    * [ ] 3.3.4.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.3.5 Refactor `AddStudentsToClassModal` component to `src/ui/organisms/AddStudentsToClassModal/AddStudentsToClassModal.tsx`. (5 SP)
    * [ ] 3.3.5.1 Create `AddStudentsToClassModal.test.tsx` for unit tests. (5 SP)
    * [ ] 3.3.5.2 Create `AddStudentsToClassModal.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.3.5.3 Create `README.md` for `AddStudentsToClassModal`. (2 SP)
    * [ ] 3.3.5.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.3.6 Refactor `DashboardContent` component to `src/ui/organisms/DashboardContent/DashboardContent.tsx`. (3 SP)
    * [ ] 3.3.6.1 Create `README.md` for `DashboardContent`. (1 SP)
    * [ ] 3.3.6.2 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.3.7 Refactor `ErrorBoundary` component to `src/ui/organisms/ErrorBoundary/ErrorBoundary.tsx`. (3 SP)
    * [ ] 3.3.7.1 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.3.8 Refactor `AnimatedSplashScreen` component to `src/ui/organisms/AnimatedSplashScreen.tsx`. (2 SP)
  * [ ] 3.3.9 Refactor `AuthForm` component to `src/ui/organisms/AuthForm.tsx`. (2 SP)
  * [ ] 3.3.10 Refactor `ClassFormModal` component to `src/ui/organisms/ClassFormModal.tsx`. (2 SP)
  * [ ] 3.3.11 Refactor `StudentBoardingInfoModal` component to `src/ui/organisms/StudentBoardingInfoModal.tsx`. (2 SP)
  * [ ] 3.3.12 Refactor `StudentCommunicationModal` component to `src/ui/organisms/StudentCommunicationModal.tsx`. (2 SP)
  * [ ] 3.3.13 Refactor `StudentIncidentReportModal` component to `src/ui/organisms/StudentIncidentReportModal.tsx`. (2 SP)
  * [ ] 3.3.14 Refactor `SubjectManager` component to `src/ui/organisms/SubjectManager.tsx`. (2 SP)
  * [ ] 3.3.15 Refactor `TeacherBoardingInfoModal` component to `src/ui/organisms/TeacherBoardingInfoModal.tsx`. (2 SP)
  * [ ] 3.3.16 Refactor `TeacherCommunicationModal` component to `src/ui/organisms/TeacherCommunicationModal.tsx`. (2 SP)
  * [ ] 3.3.17 Refactor `TeacherIncidentReportModal` component to `src/ui/organisms/TeacherIncidentReportModal.tsx`. (2 SP)
  * [ ] 3.3.18 Refactor `TeacherNotificationPanel` component to `src/ui/organisms/TeacherNotificationPanel.tsx`. (2 SP)
  * [ ] 3.3.19 Refactor `TeacherProfileView` component to `src/ui/organisms/TeacherProfileView.tsx`. (2 SP)
* [ ] **3.4 Templates (20 SP)**
  * [ ] 3.4.1 Refactor `DashboardTemplate` to `src/ui/templates/DashboardTemplate/DashboardTemplate.tsx`. (5 SP)
    * [ ] 3.4.1.1 Create `DashboardTemplate.test.tsx` for unit tests. (5 SP)
    * [ ] 3.4.1.2 Create `DashboardTemplate.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.4.1.3 Create `README.md` for `DashboardTemplate`. (2 SP)
    * [ ] 3.4.1.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.4.2 Refactor `FormTemplate` to `src/ui/templates/FormTemplate/FormTemplate.tsx`. (5 SP)
    * [ ] 3.4.2.1 Create `FormTemplate.test.tsx` for unit tests. (5 SP)
    * [ ] 3.4.2.2 Create `FormTemplate.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.4.2.3 Create `README.md` for `FormTemplate`. (2 SP)
    * [ ] 3.4.2.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.4.3 Refactor `ModalTemplate` to `src/ui/templates/ModalTemplate/ModalTemplate.tsx`. (5 SP)
    * [ ] 3.4.3.1 Create `ModalTemplate.test.tsx` for unit tests. (5 SP)
    * [ ] 3.4.3.2 Create `ModalTemplate.stories.tsx` for Storybook. (5 SP)
    * [ ] 3.4.3.3 Create `README.md` for `ModalTemplate`. (2 SP)
    * [ ] 3.4.3.4 Create `index.ts` for barrel export. (1 SP)
  * [ ] 3.4.4 Refactor `AddStudentTemplate` to `src/ui/templates/AddStudentTemplate.tsx`. (3 SP)
  * [ ] 3.4.5 Refactor `AntiBullyingResourcesTemplate` to `src/ui/templates/AntiBullyingResourcesTemplate.tsx`. (3 SP)
  * [ ] 3.4.6 Refactor `CCTVAccessRequestTemplate` to `src/ui/templates/CCTVAccessRequestTemplate.tsx`. (3 SP)
  * [ ] 3.4.7 Refactor `ClassDetailTemplate` to `src/ui/templates/ClassDetailTemplate.tsx`. (3 SP)
  * [ ] 3.4.8 Refactor `ClassDetailView` to `src/ui/templates/ClassDetailView.tsx`. (3 SP)
  * [ ] 3.4.9 Refactor `ClassReportsTemplate` to `src/ui/templates/ClassReportsTemplate.tsx`. (3 SP)
  * [ ] 3.4.10 Refactor `ClassScheduleTemplate` to `src/ui/templates/ClassScheduleTemplate.tsx`. (3 SP)
  * [ ] 3.4.11 Refactor `ClassStudentsTemplate` to `src/ui/templates/ClassStudentsTemplate.tsx`. (3 SP)
  * [ ] 3.4.12 Refactor `ClassesListTemplate` to `src/ui/templates/ClassesListTemplate.tsx`. (3 SP)
  * [ ] 3.4.13 Refactor `ParentIncidentReportTemplate` to `src/ui/templates/ParentIncidentReportTemplate.tsx`. (3 SP)
  * [ ] 3.4.14 Refactor `StudentAntiBullyingTemplate` to `src/ui/templates/StudentAntiBullyingTemplate.tsx`. (3 SP)
  * [ ] 3.4.15 Refactor `StudentDetailTemplate` to `src/ui/templates/StudentDetailTemplate.tsx`. (3 SP)
  * [ ] 3.4.16 Refactor `StudentIncidentReportTemplate` to `src/ui/templates/StudentIncidentReportTemplate.tsx`. (3 SP)
  * [ ] 3.4.17 Refactor `StudentsListTemplate` to `src/ui/templates/StudentsListTemplate.tsx`. (3 SP)
