...
// Export the complete finance service
export const financeService = {
  ...
  duplicateExpense: expenses.duplicate,
  
  // Budget management
  createBudget: budgets.upsert,
  getBudgets: budgets.getAll,
  updateBudget: budgets.upsert,
  deleteBudget: budgets.delete,
  adjustBudgetByPercentage: budgets.adjustByPercentage,
  
  // Analytics
  getBudgetHealth: analytics.getBudgetHealth,
  getSpendingByCategory: analytics.getSpendingByCategory,
  getDashboardSummary: analytics.getDashboardSummary,
  
  // Search and filters
  searchExpenses: search.searchExpenses,
  getExpensesByTimeFilter: search.getExpensesByTimeFilter,
  
  // Utilities
  getCurrentMonth: utils.getCurrentMonth,
  getFirstDayOfMonth: utils.getFirstDayOfMonth,
  formatCurrency: utils.formatCurrency,
  getDaysRemainingInMonth: utils.getDaysRemainingInMonth,
};
